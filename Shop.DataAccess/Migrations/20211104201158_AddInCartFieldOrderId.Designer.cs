...
namespace Shop.DataAccess.Migrations
{
    ...
    [Migration("20211104201158_AddInCartFieldOrderId")]
    partial class AddInCartFieldOrderId
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Shop.Domain.Models.Liked", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Shop.Domain.Models.Vendor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Shop.Domain.Models.ShopUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Shop.Domain.Models.Product", b =>
                {
                    b.HasOne("Shop.Domain.Models.Cart", null)
                        .WithMany("Products")
                        .HasForeignKey("CartId");

                    b.HasOne("Shop.Domain.Models.Category", "Categories")
                        .WithMany()
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Shop.Domain.Models.Liked", null)
                        .WithMany("Products")
                        .HasForeignKey("LikedId");

                    b.HasOne("Shop.Domain.Models.Vendor", "Vendors")
                        .WithMany()
